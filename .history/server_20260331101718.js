...
app.get("/api/auth/twitter/callback", async (req, res) => {
  ...
  try {
    ...
    // Find user by telegramId (assuming it's passed in state or stored)
    // For now, we'll need to modify this to link to the current user
    // This is a placeholder - in real implementation, state should contain userId

    res.send(`
      <h1>Twitter Connected!</h1>
      <p>Username: ${twitterUser.username}</p>
      <p>ID: ${twitterUser.id}</p>
