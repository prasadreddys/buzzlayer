...
app.get("/api/auth/twitter", (req, res) => {
  // TODO: exchange request token. Placeholder for UI integration.
  res.json({
    url: "https://twitter.com/i/oauth2/authorize?response_type=code&client_id=YOUR_CLIENT_ID&redirect_uri=" + encodeURIComponent(process.env.TWITTER_APP_CALLBACK_URL) + "&scope=tweet.read%20tweet.write%20users.read%20follows.read%20follows.write",
  });
});
